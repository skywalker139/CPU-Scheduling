...
In this project only detials of projects are shown, gantt chart is also printed, it can print non-preemptive pocesses very accurately, for preempted processes, there might be slight misplacing of process IDs, due to it not being much dynamic in making by me.
